...
# cd sh-vhost
# chmod +x ./ubuntu/18.04/default/install.sh
# ./ubuntu/18.04/default/install.sh
...
cp -v "${ABSMDL}/tmpl/index.html" "${DOCUMENT_ROOT}/index.html"
cp -v "${ABSMDL}/tmpl/.env" "${DOCUMENT_ROOT}/.env"
